...
class CarNetworking(unittest.TestCase):
    ...
    def test_login(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'login')
        self.common.login('TSP后台自动化用例.xlsx', 'login', 2, 'maxrow')

    def test_VehicleInf(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'VehicleInf')
    ...
    def test_dealerinf(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'dealerinf')
    ...
    def test_careq(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'careq')
    ...
    def test_SIM(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'SIM')
    ...
    def test_carstate(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'carstate')
    ...
    def test_XSGJ(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'XSGJ')
    ...
    def test_alarminf(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'alarminf')
    ...
    def test_SXXX(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'SXXX')
    ...
    def test_message(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'message')
    ...
    def test_appuser(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'appuser')
    ...
    def test_appmessage(self):
        self.common.cleanResult('TSP后台自动化用例.xlsx', 'appmessage')
